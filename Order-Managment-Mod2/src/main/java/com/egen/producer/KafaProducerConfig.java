...
public class KafaProducerConfig {
   ...
   * */
  @Bean
  public DefaultKafkaProducerFactory<String, GroceryOrder> producerFactoryJson() throws UnknownHostException {
    ...
    DefaultKafkaProducerFactory<String, GroceryOrder> factory = new DefaultKafkaProducerFactory<>(configProps);
  ...
  @Bean
  public KafkaTemplate<String, GroceryOrder> kafkaTemplateJson() throws UnknownHostException {
