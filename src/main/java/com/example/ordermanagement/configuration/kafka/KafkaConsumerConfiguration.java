package com.example.ordermanagement.configuration.kafka;
...
public class KafkaConsumerConfiguration {
    ...
    **/
    ...
    public DefaultKafkaConsumerFactory jsonConsumerFactory(){
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(OrdersDto.class));
    }
